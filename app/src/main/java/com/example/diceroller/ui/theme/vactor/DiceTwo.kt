...
@Composable
fun diceTwo(): VectorPainter {
    val diceTwo = ImageVector.Builder(
        name = "DiceImage",
        defaultWidth = 200.dp,
    ...
    return rememberVectorPainter(image = diceTwo)
}
