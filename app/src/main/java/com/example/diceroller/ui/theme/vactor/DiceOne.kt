...
@Composable
fun diceOne(): VectorPainter {
    val diceOne = ImageVector.Builder(
        name = "MyVector",
        defaultWidth = 200.dp,
        ...
        path(
            ...
            curveToRelative(182f, 0f, 242.19f, 139.08f, 340.27f, 258.88f)
            arcToRelative(
                14.62f, 14.62f, 0f,
                isMoreThanHalf = false,
                isPositiveArc = true,
        ...
        path(
            ...
            moveTo(297.17f, 539.02f)
            arcToRelative(
                30.12f, 16.11f, 53.82f,
                isMoreThanHalf = true,
                isPositiveArc = false,
                dx1 = 26.01f,
                dy1 = -19.02f
    ...
    return rememberVectorPainter(image = diceOne)
}