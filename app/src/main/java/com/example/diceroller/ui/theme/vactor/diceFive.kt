...
@Composable
fun diceFive(): VectorPainter {
    val diceFive = ImageVector.Builder(
        name = "CustomImage",
        defaultWidth = 200.dp,
    ...
    return rememberVectorPainter(image = diceFive)
}