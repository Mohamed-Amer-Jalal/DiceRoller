...
@Composable
fun diceThere(): VectorPainter {
    val diceThere = ImageVector.Builder(
        name = "DiceImage",
        defaultWidth = 200.dp,
    ...
    return rememberVectorPainter(image = diceThere)
}
